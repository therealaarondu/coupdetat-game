...
public class titleScreen implements Screen {
    ...
    public titleScreen(Game aGame) {
        ...
        Texture test = new Texture("title2.png");
        Image test1 = new Image(test);
        test1.setPosition(stageWidth / 2 - test1.getWidth() / 2, (float) (stageHeight / 1.25));
        ...
        imageScale = Gdx.graphics.getWidth() / background.getWidth();
        speedFixed = true;
    ...
    public void render(float delta) {
        ...
        batch.begin();
        batch.draw(background, 0, y1, Gdx.graphics.getWidth(), background.getHeight() * imageScale);
        batch.draw(background, 0, y2, Gdx.graphics.getWidth(), background.getHeight() * imageScale);
        batch.end();
